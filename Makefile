...
# monetdb.ibm.com/operator-for-monetdb-bundle:$VERSION and monetdb.ibm.com/operator-for-monetdb-catalog:$VERSION.
IMAGE_TAG_BASE ?= monetdb.ibm.com/operator-for-monetdb
